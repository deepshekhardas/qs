...
var splitKeyIntoSegments = function splitKeyIntoSegments(originalKey, options) {
    ...
    if (key === '') {
        return options.allowEmptyKeys ? [''] : undefined;
    }
...
var parseKeys = function parseQueryStringKeys(givenKey, val, options, valuesParsed) {
    if (!givenKey && !options.allowEmptyKeys) {
        return;
    }
...
var normalizeParseOptions = function normalizeParseOptions(opts) {
    ...
    if (typeof opts.allowEmptyKeys !== 'undefined' && typeof opts.allowEmptyKeys !== 'boolean') {
        throw new TypeError('`allowEmptyKeys` option can only be `true` or `false`, when provided');
    }
    ...
    return {
        ...
        allowEmptyKeys: typeof opts.allowEmptyKeys === 'boolean' ? !!opts.allowEmptyKeys : defaults.allowEmptyKeys,
